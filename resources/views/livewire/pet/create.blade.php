<x-modal wire center>
    <div class="p-4 border-b bg-gray-50 rounded-t-lg flex justify-between items-center">
        <h2 class="text-lg font-bold text-gray-800">Cadastrar Novo Pet</h2>
    ...
    <form wire:submit="save">
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-1 md:col-span-2 flex flex-col items-center justify-center mb-2">
                <div class="relative group">
                    ...
                    <label for="foto-create" class="absolute bottom-1 right-1 bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-full shadow-md cursor-pointer transition-colors duration-200">
                        <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                        <input id="foto-create" type="file" wire:model="foto" accept="image/*" class="hidden">
                    </label>
                </div>
                <div class="mt-2 h-5 text-center">
                    <span wire:loading wire:target="foto" class="text-xs text-blue-600 font-semibold animate-pulse">Carregando...</span>
            ...
            <div>
                ...
                <input type="text" wire:model="nome" placeholder="Ex: Rex" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition duration-150">
            ...
            <div>
                ...
                <select wire:model="raca" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition duration-150">
                    <option value="">Indefinida / Selecione...</option>
            ...
            <div>
                ...
                <x-date wire:model="data_nascimento" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition duration-150"/>
        ...
        <div class="flex justify-end gap-3 p-4 bg-gray-50 rounded-b-lg border-t">
            ...
            <button type="submit" wire:loading.attr="disabled" class="px-5 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-sm transition-colors flex items-center">
                <svg wire:loading wire:target="foto, save" class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24">
